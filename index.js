...
p.nominalBounds = new cjs.Rectangle(0,0,901,331);
...
p.nominalBounds = new cjs.Rectangle(-337.5,-116,902.5,331);
...
if (reversed == null) { reversed = false; }
	...
	this.Button.setTransform(1648,561.2,1,1,0,0,0,1648,561.2);
	this.Button.depth = 0;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"BG_wide.jpg?1759880300486", id:"BG_wide"},
		{src:"btn1.png?1759880300486", id:"btn1"},
		{src:"btn2.png?1759880300486", id:"btn2"},
		{src:"btn3.png?1759880300486", id:"btn3"},
		{src:"Logo.png?1759880300486", id:"Logo"},
		{src:"Pointer.png?1759880300486", id:"Pointer"},
		{src:"Stand.png?1759880300486", id:"Stand"},
		{src:"Wheel.png?1759880300486", id:"Wheel"}
	],
	preloads: []
};
